...
<?php $component->withAttributes(['title' => 'Etablissement page']); ?>
   ...
   <div class="soft-card p-3 mb-4" data-aos="fade-up">
                ...
                <div class="card-body p-4">
                    <form action="<?php echo e(route('etablissement.store')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="name" class="form-label"><?php echo e(__('messages.type_etablissement_name')); ?></label>
                                <input type="text" class="form-control" id="name" name="name" value="<?php echo e(old('name')); ?>" placeholder="<?php echo e(__('messages.type_etablissement_name_placeholder')); ?>">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="col-md-3">
                            <label for="programme_id" class="form-label"><?php echo e(__('messages.programme')); ?></label>
                            ...
                            <select name="programme_id" id="programme_id" 
                                ...
                                <?php $__currentLoopData = $programmes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $programme): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($programme->id); ?>" 
                                        <?php echo e(old('programme_id') == $programme->id ? 'selected' : ''); ?>>
...
<?php endif; ?>
<?php /**PATH D:\5edma\hatha howa s7i7!!!!!!\suivi-projet-devlope (1)\suivi-projet-devlope\resources\views/etablissement/create.blade.php ENDPATH**/ ?>