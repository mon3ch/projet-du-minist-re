<div class="d-flex align-items-center justify-content-between mb-3">
  <h5 class="m-0">
    <i class="fa-solid fa-users-gear me-2"></i><?php echo e(__('messages.type_etablissements_list')); ?> (<?php echo e($etablissements->count()); ?>)
  </h5>
  <span class="text-muted small">

        <button class="btn btn-primary quick-btn">
                <a class="nav-link" href="<?php echo e(route('etablissement.create')); ?>">        <i class="fa-solid fa-school me-1"></i><?php echo e(__('messages.add_type_etablissement')); ?>
    ...
    <div class="table-responsive">
      <table class="align-middle mb-0 table-hover" style="width: 100%;">
        <thead class="table-light">
          <tr>
            <th>id</th>
            <th scope="col"><?php echo e(__('messages.type_etablissement_name')); ?></th>
        ...
        <tbody class="table-modern">
          ...
          <tr>
            ...
            <td>
              <?php echo e($etablissement->programme ? $etablissement->programme->name : '—'); ?>

            </td>
            <td class="text-center">
              <form action="<?php echo e(route('etablissement.edit', $etablissement->id)); ?>" method="GET" class="d-inline">
                <?php echo csrf_field(); ?>
                <button type="submit" class="btn btn-sm btn-outline-primary me-1">
                  <i class="fa-solid fa-pen"></i>
                </button>
              </form>
              <form action="<?php echo e(route('etablissement.destroy', $etablissement->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('<?php echo e(__('messages.delete_question')); ?>')">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH D:\5edma\hatha howa s7i7!!!!!!\suivi-projet-devlope (1)\suivi-projet-devlope\resources\views/components/etablissement-table.blade.php ENDPATH**/ ?>