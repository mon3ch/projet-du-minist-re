...
<head>
    ...
    <title>Suivie des projets | <?php echo e($title); ?> </title>
    <link rel="icon" href="<?php echo e(asset('storage/logo/icon.png')); ?>" type="image/x-icon" />

    <?php if(app()->getLocale() === 'ar'): ?>
        <link rel="stylesheet" href="<?php echo e(asset('css/rtl.css')); ?>">
    <?php else: ?>
        <link rel="stylesheet" href="<?php echo e(asset('css/ltr.css')); ?>">
    <?php endif; ?>
...
<?php /**PATH D:\5edma\hatha howa s7i7!!!!!!\suivi-projet-devlope (1)\suivi-projet-devlope\resources\views/components/master.blade.php ENDPATH**/ ?>