    ...
    <div class="content">
        ...
        <?php echo $__env->make('partials.sidebar.admin.sidebar', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
                <div class="card-header  d-flex justify-content-between align-items-center">
                    <h4 class="mb-0"><i class="fa-solid fa-user-plus me-2"></i> <?php echo e(__('messages.add_user')); ?></h4>
                </div>
                        ...
                        <div class="row g-3">
                                    ...
                                    <div class="col-md-6">
                                        <?php if(Auth::user()->image): ?>
                                            <img src="<?php echo e(asset('storage/'.Auth::user()->image)); ?>" alt="Profile Image" class="rounded-circle" width="100" height="100">
                                        <?php else: ?>
                                            <p><?php echo e(__('messages.no_profile_image')); ?></p>
                                        <?php endif; ?>
                                </div>
                            <div class="col-md-6">
                                <label for="last_name" class="form-label"><?php echo e(__('messages.last_name')); ?></label>
                                <input type="text" class="form-control" id="last_name" name="last_name" value="<?php echo e(old('last_name')); ?>" placeholder="<?php echo e(__('messages.last_name_placeholder')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="first_name" name="first_name" value="<?php echo e(old('first_name')); ?>" placeholder="<?php echo e(__('messages.first_name_placeholder')); ?>">
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="<?php echo e(__('messages.email_placeholder')); ?>">
                                </div>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3">
                                <label for="is_admin" class="form-label"><?php echo e(__('messages.role')); ?></label>
                                <select name="is_admin" id="is_admin" class="form-select">
                                    <option value="1"><?php echo e(__('messages.admin')); ?></option>
                                    <option value="0"><?php echo e(__('messages.user')); ?></option>
                                </select>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-md-3">
                                <label for="is_active" class="form-label"><?php echo e(__('messages.status')); ?></label>
...
<?php endif; ?>
<?php /**PATH D:\5edma\hatha howa s7i7!!!!!!\suivi-projet-devlope (1)\suivi-projet-devlope\resources\views/profile/create.blade.php ENDPATH**/ ?>