<div class="d-flex align-items-center justify-content-between mb-3">
  <h5 class="m-0">
    <i class="fa-solid fa-users-gear me-2"></i><?php echo e(__('messages.programmes_list')); ?> (<?php echo e($programmes->count()); ?>)
  </h5>
  <span class="text-muted small">

        <button class="btn btn-primary quick-btn">
                <a class="nav-link" href="<?php echo e(route('programme.create')); ?>">        
                  <i class="fa-solid fa-school me-1"></i><?php echo e(__('messages.add_programme')); ?>
    ...
    <div class="table-responsive">
      <table class="align-middle mb-0 table-hover" style="width: 100%;">
        <thead class="table-light">
          <tr>
            <th>id</th>
            <th scope="col"><?php echo e(__('messages.programme_name')); ?></th>
        ...
        <tbody class="table-modern">
          ...
          <tr>
            ...
            <td class="text-center">
              <form action="<?php echo e(route('programme.edit', $programme->id)); ?>" method="GET" class="d-inline">
                <?php echo csrf_field(); ?>
                <button type="submit" class="btn btn-sm btn-outline-primary me-1">
                  <i class="fa-solid fa-pen"></i>
                </button>
              </form>
              <form action="<?php echo e(route('programme.destroy', $programme->id)); ?>" method="POST" class="d-inline" onsubmit="return confirm('<?php echo e(__('messages.delete_question')); ?>')">
                <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php /**PATH D:\5edma\New folder (2)\suivi-projet-devlope (1)\suivi-projet-devlope\resources\views/components/programme-table.blade.php ENDPATH**/ ?>