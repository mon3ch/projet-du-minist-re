        ...
        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nom_projet" name="nom_projet"
                                    value="{{ old('nom_projet') }}" placeholder="{{ __('messages.project_name') }}">
                                @error('nom_projet')
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea class="form-control" readonly id="description" name="description" placeholder="سيتم تحديد هذه القيمة تلقائيا">{{ old('description') }}</textarea>
                                @error('description')
                                    <div class="text-danger mt-2">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="details_projet" name="details_projet" placeholder="{{ __('messages.details_projet') }}">{{ old('description') }}</textarea>
...
<div class="col-md-6">
    <label for="gouvernorat_id" class="form-label">
        <span class="text-danger">*</span> {{ __('messages.gouvernorat') }}
    </label>
...
<div class="col-md-6">
    <label for="delegation_id" class="form-label">
        <span class="text-danger">*</span> {{ __('messages.delegation') }}
    </label>
    <select name="delegation_id" id="delegation_id" class="form-select shadow-sm border-primary">
        ...
        @if(old('gouvernorat_id'))
            @foreach(App\Models\Delegation::where('gouvernorat_id', old('gouvernorat_id'))->get() as $delegation)
...
<div class="col-md-4">
    <label for="programme_id" class="form-label">
        <span class="text-danger">*</span> {{ __('messages.programme') }}
    </label>
...
<div class="col-md-4">
    <label for="etablissement_id" class="form-label">
        <span class="text-danger">*</span> {{ __('messages.type_etablissement') }}
    </label>
    <select name="etablissement_id" id="etablissement_id" class="form-select shadow-sm border-primary">
        ...
        @if(old('programme_id'))
            @foreach(App\Models\Etablissement::where('programme_id', old('programme_id'))->get() as $etab)
...
<div class="col-md-4">
    <label for="name_etablissement_id" class="form-label">
        <span class="text-danger">*</span> {{ __('messages.name_etablissement') }}
    </label>
    <select name="name_etablissement_id" id="name_etablissement_id" class="form-select shadow-sm border-primary">
        ...
        @if(old('etablissement_id') && old('gouvernorat_id'))
            @foreach(App\Models\names_etablissements::where('etablissement_id', old('etablissement_id'))
                ->where('gouvernorat_id', old('gouvernorat_id'))  {{-- فلترة حسب Gouvernorat --}}
                ->get() as $name)
                <option value="{{ $name->id }}" {{ old('name_etablissement_id') == $name->id ? 'selected' : '' }}>
                    {{ $name->name }}
                </option>
            @endforeach
        @endif
        ...
        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="nature_projet_id" id="nature_projet_id" class="form-select shadow-sm border-primary">
                                    ...
                                    @foreach($nature_projets as $nature_projet)
                                        <option value="{{ $nature_projet->id }}" {{ old('nature_projet_id') == $nature_projet->id ? 'selected' : '' }}>
                                            {{ $nature_projet->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="type_projet_id" id="type_projet_id" class="form-select shadow-sm border-primary">
                                    ...
                                    @foreach($type_projets as $type_projet)
                                        <option value="{{ $type_projet->id }}" {{ old('type_projet_id') == $type_projet->id ? 'selected' : '' }}>
                                            {{ $type_projet->name }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-4">
                                ...
                                <select name="situation_etablissement_fonctionnelle" id="situation_etablissement_fonctionnelle" class="form-select shadow-sm border-primary">
                                    ...
                                    <option value="وظيفية" {{ old('situation_etablissement_fonctionnelle') == 'وظيفية'? 'selected' : '' }}>
                                        وظيفية
                                    </option>

                                    <option value="غير وظيفية" {{ old('situation_etablissement_fonctionnelle') == 'غير وظيفية'? 'selected' : '' }}>
                                        غير وظيفية
                                    </option>
                                    
                                    <option value="أرض بيضاء" {{ old('situation_etablissement_fonctionnelle') == 'أرض بيضاء'? 'selected' : '' }}>
                                        أرض بيضاء
                                    </option>
                                    
                                    <option value="مغلق" {{ old('situation_etablissement_fonctionnelle') == 'مغلق'? 'selected' : '' }}>
                                        مغلق 
                                    </option>
                                    
                                    <option value="مغلق جزئيا" {{ old('situation_etablissement_fonctionnelle') == 'مغلق جزئيا'? 'selected' : '' }}>
                                        مغلق جزئيا
                                    </option>
                                </select>
                                ...
                                <select name="tranche" id="tranche" class="form-select shadow-sm border-primary">
                                    ...
                                    <option value="القسط الأول" {{ old('tranche') == "القسط الأول"? 'selected' : '' }}>
                                        القسط الأول
                                    </option>

                                    <option value="القسط الثاني" {{ old('tranche') == "القسط الثاني"? 'selected' : ''  }}>
                                        القسط الثاني
                                    </option>

                                    <option value="القسط الثالث" {{ old('tranche') == "القسط الثالث" ? 'selected' : ''  }}>
                                        القسط الثالث
                                    </option>

                                    <option value="القسط الرابع" {{ old('tranche') == "القسط الرابع" ? 'selected' : ''  }}>
                                        القسط الرابع
                                    </option>
                                </select>
                                @error('tranche')
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="situation_immobiliere" id="situation_immobiliere" class="form-select shadow-sm border-primary">
                                    ...
                                    <option value="مخصص" {{ old('situation_immobiliere') == 'مخصص'? 'selected' : '' }}>
                                        مخصص
                                    </option>

                                    <option value="غير مخصص" {{ old('situation_immobiliere') == 'غير مخصص'? 'selected' : ''  }}>
                                        غير مخصص
                                    </option>

                                    <option value="في طور التخصيص" {{ old('situation_immobiliere') == 'في طور التخصيص' ? 'selected' : ''  }}>
                                        في طور التخصيص
                                    </option>

                                    <option value="ملك بلدي" {{ old('situation_immobiliere') == 'ملك بلدي' ? 'selected' : ''  }}>
                                        ملك بلدي
                                    </option>
                                      <option value="مخصص جزئيا" {{ old('situation_immobiliere') == 'مخصص جزئيا' ? 'selected' : ''  }}>
                                         مخصص جزئيا
                                    </option>
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="financement_id" id="financement_id" class="form-select shadow-sm border-primary">
                                    ...
                                    @foreach($financements as $financement)
                                        <option value="{{ $financement->id }}" {{ old('financement_id') == $financement->id ? 'selected' : '' }}>
                                            {{ $financement->name }}
                                        </option>
                                    @endforeach
                                </select>
        ...
        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="number" maxlength="4" oninput="if(this.value.length > 4) this.value = this.value.slice(0, 4);" class="form-control" id="estimation_budgetaire" name="estimation_budgetaire"
                                    value="{{ old('estimation_budgetaire') }}" placeholder="{{ __('messages.budget') }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="phase_projet" id="phase_projet" class="form-select shadow-sm border-primary">
                                    ...
                                    <option value="في طور اعداد الملف المرجعي" {{ old('phase_projet') == 'في طور اعداد الملف المرجعي'? 'selected' : '' }}>
                                        في طور اعداد الملف المرجعي
                                    </option>
                                    
                                    <option value="بصدد الدراسة" {{ old('phase_projet') == 'بصدد الدراسة'? 'selected' : '' }}>
                                        بصدد الدراسة
                                    </option>


                                    <option value="بصدد الانجاز" {{ old('phase_projet') == 'بصدد الانجاز'? 'selected' : '' }}>
                                        بصدد الانجاز
                                    </option>
                                    
                                    <option value="توقف الأشغال" {{ old('phase_projet') == 'توقف الأشغال'? 'selected' : '' }}>
                                        توقف الأشغال
                                    </option>


                                    <option value="بصدد طلب العروض" {{ old('phase_projet') == 'بصدد طلب العروض'? 'selected' : '' }}>
                                        بصدد طلب العروض
                                    </option>
                                    
                                    <option value="اعادة طلب العروض" {{ old('phase_projet') == 'اعادة طلب العروض'? 'selected' : '' }}>
                                        اعادة طلب العروض 
                                    </option>

                                    <option value="قبول وقتي" {{ old('phase_projet') == 'قبول وقتي'? 'selected' : '' }}>
                                       قبول وقتي 
                                    </option>
                                    
                                    <option value="قبول نهائي" {{ old('phase_projet') == 'قبول نهائي'? 'selected' : '' }}>
                                        قبول نهائي
                                    </option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" maxlength="4" oninput="if(this.value.length > 4) this.value = this.value.slice(0, 4);" class="form-control" id="cout_marche" name="cout_marche"
                                    value="{{ old('cout_marche') }}" placeholder="{{ __('messages.cout_marche') }}">
                                @error('cout_marche')
                                    <div class="text-danger mt-2">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" maxlength="4" oninput="if(this.value.length > 4) this.value = this.value.slice(0, 4);" 
                                    ...
                                    value="{{ old('credit_recommande_engager') }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" maxlength="4" oninput="if(this.value.length > 4) this.value = this.value.slice(0, 4);"
                                    ...
                                    value="{{ old('credit_recommande_Payeur') }}" 
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" id="pourcentage_avancement" name="pourcentage_avancement">
                                    ...
                                    @for ($i = 5; $i <= 100; $i += 5)
                                        <option value="{{ $i }}" {{ old('pourcentage_avancement') == $i ? 'selected' : '' }}>{{ $i }}%</option>
                                    @endfor
                                </select>
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea class="form-control" id="Remarque" name="Remarque" placeholder="{{ __('messages.remarque') }}">{{ old('Remarque') }}</textarea>
                                @error('Remarque')
                                    <div class="text-danger mt-2">{{ $message }}</div>
                                @enderror
                            </div>
...
<div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control" id="duree" name="duree"
                                    value="{{ old('duree') }}" placeholder="{{ __('messages.duration') }}">
                                @error('duree')
                                    <div class="text-danger mt-2">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="date_fin_travaux" name="date_fin_travaux" value="{{ old('date_fin_travaux') }}" readonly>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control" id="date_acceptation_temporaire" name="date_acceptation_temporaire"
                                    value="{{ old('date_acceptation_temporaire') }}">
                            ...
                            <div class="col-md-6"> <label for="date_acceptation_finale" class="form-label">{{ __('messages.date_acceptation_finale') }}</label> 
                                <input type="date" class="form-control" id="date_acceptation_finale" name="date_acceptation_finale" value="{{ old('date_acceptation_finale') }}"> 
       ...
       <div class="step-content col-md-12  mt-4" id="step-4" >
                ...
                <p class="text-danger"><b> اختر موقع المشروع من الخريطة </b></p>
                  ...
                  {{--  <label for="latitude" class="form-label">
                    ...
                    <input type="hidden" class="form-control" readonly id="latitude" name="latitude"
                        value="{{ old('latitude') }}" placeholder="مثال : 36.8065">
                    @error('latitude')
                        <div class="text-danger mt-2">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="col-md-6">
                   {{--  <label for="longitude" class="form-label">
                        <span class="text-danger">*</span> خط الطول
                    </label>--}}
                    <input type="hidden" class="form-control" readonly id="longitude" name="longitude"
                        value="{{ old('longitude') }}" placeholder="مثال : 10.1815">
                    @error('longitude')
                        <div class="text-danger mt-2">{{ $message }}</div>
                    @enderror
                </div>
...
document.getElementById('gouvernorat_id').addEventListener('change', function () {
    ...
    delegationSelect.innerHTML = '<option value="">{{ __('messages.select_delegation') }}';
...
document.getElementById('programme_id').addEventListener('change', function () {
    ...
    const etablissementSelect = document.getElementById('etablissement_id');
    etablissementSelect.innerHTML = '<option value="">{{ __('messages.select_etablissement') }}</option>';
